...
from utils.environments.reacher import RoboschoolReacher
            ...
            if isinstance(env_id, str):
                if env_id == 'CartPole-v1':
                    ...
                    if env_kwargs['env_id'] == 0:
                        ...
                        #print (env.power)
                elif env_id == 'RoboschoolReacher-v1':
                    if env_kwargs['env_id'] == 1: #simulation    
                        env = TimeLimitWrapper(RoboschoolReacher(model_xml_name='reacher_1.xml'), 150)
                    elif env_kwargs['env_id'] == 0:
                        env = TimeLimitWrapper(RoboschoolReacher(model_xml_name='reacher_0.xml'), 150)
                    elif env_kwargs['env_id'] == -1:
                         env = TimeLimitWrapper(RoboschoolReacher(model_xml_name='reacher_minus_1.xml'), 150)
                    elif env_kwargs['env_id'] == -2:
                         env = TimeLimitWrapper(RoboschoolReacher(model_xml_name='reacher_plus1.xml'), 150)
                    else:
                        NotImplementedError
