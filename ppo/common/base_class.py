...
from ppo.common.callbacks import BaseCallback, CallbackList, ConvertCallback, ProgressBarCallback
from ppo.common.env_util import is_wrapped
from ppo.common.logger import Logger
from ppo.common.monitor import Monitor
from ppo.common.noise import ActionNoise
from ppo.common.policies import BasePolicy
from ppo.common.preprocessing import check_for_nested_spaces, is_image_space, is_image_space_channels_first
from ppo.common.save_util import load_from_zip_file, recursive_getattr, recursive_setattr, save_to_zip_file
from ppo.common.type_aliases import GymEnv, MaybeCallback, Schedule
from ppo.common.utils import (
...
from ppo.common.vec_env import (
    DummyVecEnv,
    VecEnv,
    VecNormalize,
    VecTransposeImage,
...
class BaseAlgorithm(ABC):
    ...
    def __init__(
        ...
        env_collect: Union[GymEnv, str, None],
        ...
        if env is not None:
            ...
            #env_collect = maybe_make_env(env_collect, self.verbose)
            #env_collect = self._wrap_env(env_collect, self.verbose, monitor_wrapper)

            self.observation_space = env.observation_space
            self.action_space = env.action_space
            self.n_envs = env.num_envs
            self.env = env
            self.env_collect = env_collect
    ...
    def load(
        ...
        env_collect: Optional[GymEnv]=None,
        device: Union[th.device, str] = "auto",
